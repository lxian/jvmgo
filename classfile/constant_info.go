...
func newConstantInfo(flag uint8, constantPool ConstantPool) ConstantInfo {
	switch flag {
	case CONSTANT_Class: return &ConstantClassInfo{constantPool:constantPool}
	case CONSTANT_Fieldref, CONSTANT_Methodref, CONSTANT_InterfaceMethodref: return &ConstantMemberRefInfo{constantPool:constantPool}
	case CONSTANT_String: return &ConstantStringInfo{constantPool:constantPool}
	...
	case CONSTANT_NameAndType: return &ConstantNameAndType{}
